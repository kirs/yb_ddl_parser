...
#define ERRCODE_YB_ERROR MAKE_SQLSTATE('Y','B','0','0','0')
#define ERRCODE_YB_TXN_ABORTED MAKE_SQLSTATE('Y','B','0','0','1')
#define ERRCODE_YB_RESTART_READ MAKE_SQLSTATE('Y','B','0','0','2')
#define ERRCODE_YB_TXN_CONFLICT MAKE_SQLSTATE('Y','B','0','0','3')
#define ERRCODE_YB_DEADLOCK MAKE_SQLSTATE('Y','B','0','0','4')
#define ERRCODE_YB_TXN_SKIP_LOCKING MAKE_SQLSTATE('Y','B','0','1','0')
#define ERRCODE_YB_TXN_LOCK_NOT_FOUND MAKE_SQLSTATE('Y','B','0','1','1')
