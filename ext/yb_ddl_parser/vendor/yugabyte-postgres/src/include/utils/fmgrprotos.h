...
extern Datum yb_servers(PG_FUNCTION_ARGS);
extern Datum yb_hash_code(PG_FUNCTION_ARGS);
extern Datum ybginhandler(PG_FUNCTION_ARGS);
extern Datum yb_catalog_version(PG_FUNCTION_ARGS);
extern Datum yb_is_local_table(PG_FUNCTION_ARGS);
extern Datum yb_table_properties(PG_FUNCTION_ARGS);
extern Datum yb_is_database_colocated(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_get_backend_catalog_version(PG_FUNCTION_ARGS);
extern Datum yb_get_range_split_clause(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_get_queries(PG_FUNCTION_ARGS);
extern Datum yb_server_region(PG_FUNCTION_ARGS);
extern Datum yb_server_cloud(PG_FUNCTION_ARGS);
extern Datum yb_server_zone(PG_FUNCTION_ARGS);
extern Datum binary_upgrade_set_next_tablegroup_oid(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_get_backend_allocated_mem_bytes(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_get_backend_rss_mem_bytes(PG_FUNCTION_ARGS);
extern Datum yb_heap_stats(PG_FUNCTION_ARGS);
extern Datum yb_get_current_transaction_priority(PG_FUNCTION_ARGS);
extern Datum yb_get_effective_transaction_isolation_level(PG_FUNCTION_ARGS);
extern Datum yb_get_percentile(PG_FUNCTION_ARGS);
extern Datum yb_lock_status(PG_FUNCTION_ARGS);
extern Datum yb_cancel_transaction(PG_FUNCTION_ARGS);
extern Datum yb_get_current_transaction(PG_FUNCTION_ARGS);
extern Datum yb_active_session_history(PG_FUNCTION_ARGS);
extern Datum yb_local_tablets(PG_FUNCTION_ARGS);
extern Datum yb_query_diagnostics(PG_FUNCTION_ARGS);
extern Datum yb_wait_event_desc(PG_FUNCTION_ARGS);
extern Datum yb_get_query_diagnostics_status(PG_FUNCTION_ARGS);
extern Datum binary_upgrade_set_next_tablegroup_default(PG_FUNCTION_ARGS);
extern Datum yb_servers_metrics(PG_FUNCTION_ARGS);
extern Datum yb_database_clones(PG_FUNCTION_ARGS);
extern Datum yb_cancel_query_diagnostics(PG_FUNCTION_ARGS);
extern Datum yb_get_current_hybrid_time_lsn(PG_FUNCTION_ARGS);
extern Datum yb_xcluster_set_next_oid_assignments(PG_FUNCTION_ARGS);
extern Datum yb_backend_heap_snapshot(PG_FUNCTION_ARGS);
extern Datum yb_backend_heap_snapshot_peak(PG_FUNCTION_ARGS);
extern Datum yb_log_backend_heap_snapshot(PG_FUNCTION_ARGS);
extern Datum yb_log_backend_heap_snapshot_peak(PG_FUNCTION_ARGS);
extern Datum yb_log_catcache_stats(PG_FUNCTION_ARGS);
extern Datum yb_index_check(PG_FUNCTION_ARGS);
...
extern Datum yb_binary_upgrade_set_next_pg_enum_sortorder(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_get_backend_local_catalog_version(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_get_backend_pss_mem_bytes(PG_FUNCTION_ARGS);
extern Datum yb_compute_row_ybctid(PG_FUNCTION_ARGS);
extern Datum yb_get_tablet_metadata(PG_FUNCTION_ARGS);
extern Datum yb_binary_upgrade_set_next_colocation_id(PG_FUNCTION_ARGS);
extern Datum yb_get_local_tserver_uuid(PG_FUNCTION_ARGS);
extern Datum yb_levenshtein(PG_FUNCTION_ARGS);
extern Datum yb_levenshtein_with_costs(PG_FUNCTION_ARGS);
extern Datum yb_levenshtein_less_equal(PG_FUNCTION_ARGS);
extern Datum yb_levenshtein_less_equal_with_costs(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_plans_insert(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_plans_get_all_entries(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_plans_reset(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_plans_total_time(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_plans_total_calls(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_plans_read_file(PG_FUNCTION_ARGS);
extern Datum yb_pg_stat_plans_write_file(PG_FUNCTION_ARGS);
extern Datum yb_stat_auto_analyze(PG_FUNCTION_ARGS);
extern Datum yb_get_tablet_for_key(PG_FUNCTION_ARGS);
