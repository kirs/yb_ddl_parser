...
ALTER TABLE pg_yb_catalog_version ADD PRIMARY KEY USING INDEX pg_yb_catalog_version_db_oid_index;

ALTER TABLE pg_yb_invalidation_messages ADD PRIMARY KEY USING INDEX pg_yb_invalidation_messages_db_oid_current_version_index;

ALTER TABLE pg_yb_logical_client_version ADD PRIMARY KEY USING INDEX pg_yb_logical_client_version_db_oid_index;

ALTER TABLE pg_yb_profile ADD PRIMARY KEY USING INDEX pg_yb_profile_oid_index;

ALTER TABLE pg_yb_profile ADD UNIQUE USING INDEX pg_yb_profile_prfname_index;

ALTER TABLE pg_yb_role_profile ADD PRIMARY KEY USING INDEX pg_yb_role_profile_oid_index;

ALTER TABLE pg_yb_tablegroup ADD PRIMARY KEY USING INDEX pg_yb_tablegroup_oid_index;
